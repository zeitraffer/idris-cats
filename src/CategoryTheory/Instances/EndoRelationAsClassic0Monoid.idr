...
data UnitMorphism : EndoRelation_Arrow unit where
  MkUnitMorphism : UnitMorphism () ()

instance EndoRelationClass unit where
  (~>) = UnitMorphism
...
IsProductMorphism :
  (rLeft, rRight: EndoRelationRecord) -> EndoRelation_Arrow ( |rLeft| # |rRight| )
...
instance Classic0MonoidClass EndoRelationRecord where
