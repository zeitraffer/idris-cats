...
recTo : (rec: Classic0CategoryFullRecord) -> recOb rec ->> Type
recTo (MkClassic0CategoryFull ob to inst) = to

recInstance : (rec: Classic0CategoryFullRecord) -> Classic0CategoryFullClass (recOb rec) (recTo rec)
recInstance (MkClassic0CategoryFull ob to inst) = inst

instance ObClass Classic0CategoryFullRecord where
  Ob = recOb
...
jd : (Classic0CategoryFullClass ob to) => {o: ob} -> 
    (o `to` o)
jd {ob} {to} {o} = 
