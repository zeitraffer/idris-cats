...
class Classic0MonoidClass (carrier : Type) where
...
data Classic0MonoidRecord : Type where
  MkClassic0Monoid : 
    (carrier: Type) -> 
...
recInstance : (rec: Classic0MonoidRecord) -> Classic0MonoidClass (recCarrier rec)
...
instance ObClass Classic0MonoidRecord where
  Ob = recCarrier    
